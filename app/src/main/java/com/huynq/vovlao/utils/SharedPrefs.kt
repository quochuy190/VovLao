...
class SharedPrefs private constructor(){
    ...
    init {
        mSharedPreferences = VoVApplication.instance!!.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
    }
    ...
    fun <T> put(key: String, data: T) {
        ...
        when (data) {
            ...
            else -> editor.putString(key, VoVApplication.instance?.gSon?.toJson(data))
        }
        editor.apply()
    }
